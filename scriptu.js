...
app.get('/addbook', function(req,res){
    res.render("addbook.ejs", {type: "USER", redirect:"/user"})
})
...
app.get('/manageaccount', function(req,res){
    res.render("manageaccount.ejs", {name:"name",email:"test2",phone:"correct",address:"fuiuu",pin:"34414314",libid:"12431421"})
})
